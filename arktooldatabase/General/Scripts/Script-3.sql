-- REQ-20260116-007
-- Script corregido para MariaDB 11.8.3 - Base de datos NAUTILUS
...
CREATE TABLE IF NOT EXISTS nau_company (
    ...
    emp_FechaCreacion     TIMESTAMP DEFAULT CURRENT_TIMESTAMP(),
    emp_SystemDate        DATE,
    emp_SystemTime        TIME,
...
CREATE TABLE IF NOT EXISTS nau_clients (
    ...
    clt_FechaCreacion     TIMESTAMP DEFAULT CURRENT_TIMESTAMP(),
    clt_SystemDate        DATE,
    clt_SystemTime        TIME,
...
CREATE TABLE IF NOT EXISTS nau_currencies (
    ...
    mda_FechaCreacion      TIMESTAMP DEFAULT CURRENT_TIMESTAMP(),
...
CREATE TABLE IF NOT EXISTS nau_functional_units (
    ...
    fun_FechaCreacion  TIMESTAMP DEFAULT CURRENT_TIMESTAMP(),
    fun_SystemDate     DATE,
    fun_SystemTime     TIME,
...
CREATE TABLE IF NOT EXISTS nau_job_titles (
    ...
    job_FechaCreacion  TIMESTAMP DEFAULT CURRENT_TIMESTAMP(),
    job_SystemDate     DATE,
    job_SystemTime     TIME,
...
CREATE TABLE IF NOT EXISTS nau_employees (
    ...
    emy_Password       TEXT,
    emy_FechaCreacion  TIMESTAMP DEFAULT CURRENT_TIMESTAMP(),
    emy_SystemDate     DATE,
    emy_SystemTime     TIME,
...
CREATE TABLE IF NOT EXISTS nau_users (
    ...
    usr_Password       TEXT,
    usr_FechaCreacion  TIMESTAMP DEFAULT CURRENT_TIMESTAMP(),
    id_employee        INTEGER,
    usr_SystemDate     DATE,
    usr_SystemTime     TIME,
