...
ALTER TABLE ark_session_details RENAME COLUMN dts_systemdate TO dts_SystemDate;
ALTER TABLE ark_session_details RENAME COLUMN dts_systemtime TO dts_SystemTime;
ALTER TABLE ark_session_details RENAME COLUMN dts_namemachine TO dts_NameMachine;
ALTER TABLE ark_session_details RENAME COLUMN dts_usercreator TO dts_UserCreator;
ALTER TABLE ark_session_details RENAME COLUMN dts_lastupdatedate TO dts_LastUpdateDate;
ALTER TABLE ark_session_details RENAME COLUMN dts_lastupdatetime TO dts_LastUpdateTime;
ALTER TABLE ark_session_details RENAME COLUMN dts_lastmachine TO dts_LastMachine;
ALTER TABLE ark_session_details RENAME COLUMN dts_userlastupdate TO dts_UserLastUpdate;
