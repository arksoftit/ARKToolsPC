...
################################################################################
## Form generated from reading UI file 'arktoolspcg2eTGaEo.ui'
##
...
"}")
        ...
        self.dateEdit_ses_fechaemision.setMaximumDateTime(QDateTime(QDate(2501, 1, 7), QTime(23, 59, 59)))
...
"}")
        ...
        self.dateEdit_ses_fechasesion.setMaximumDateTime(QDateTime(QDate(2501, 1, 9), QTime(23, 59, 59)))
